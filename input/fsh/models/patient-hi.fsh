...
* Geschlecht 1..1 code "Geschlecht"
* Geschlecht from https://termgit.elga.gv.at/ValueSet/elga-administrativegender
...
* Versorgungsnetzwerk.Kontakttyp 1..1 code "Team Primärversorgung/hausärztliches
Team | Niedergelassene Fachärzte für innere Medizin/Kardiologie | HI-Spezialist/Spezialambulanz | Krankenhaus/stationär | Rehabilitation"
