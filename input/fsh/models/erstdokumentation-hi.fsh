...
* Komorbiditaeten 1..1 boolean "Komorbiditäten"
...
* Symptomatik 1..1 code "Symptomatik/klinischer Status (NYHA I | NYHA II | NYHA III | NYHA IV)"
...
2006) verwendet."""
* Diagnose 1..1 code "HFrEF | HFmrEF | HFpEF"
* Behandlungsziel 1..1 code "1 | 2 | 3a | 3b"
* Ressourcen 1..1 code "Ressourcen der Patienten/Angehörigen (Selbstmanagement möglich (regelmäßiges Monitoring wichtiger Parameter) | prinzipiell Selbstmanagement (Überprüfung in definierten Zeitintervallen) | Kontinuierliche Supervision)"
